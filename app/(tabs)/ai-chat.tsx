        ...
        <View style={styles.footer}>
          <View style={styles.inputRow}>
            ...
            <TouchableOpacity
              ...
              onPress={sendMessage}
            >
              <Send size={18} color={inputText.trim() ? "#fff" : C.textSubtle} />
            </TouchableOpacity>
          </View>
        </View>
      </KeyboardAvoidingView>
...
function makeStyles(C: ThemeColors) {
  return StyleSheet.create({
    ...
    onlineText:  { color: C.success, fontSize: 12, fontWeight: "700" },
    ...
    tDot:       { width: 6, height: 6, borderRadius: 3, backgroundColor: C.textSubtle },
    tDotMid:    { backgroundColor: C.textMuted },
    typingText: { color: C.textSubtle, fontSize: 12, fontStyle: "italic" },
